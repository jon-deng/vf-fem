...
class TestFormAssembler(UFLFormFixtures):
    ...
    @pytest.fixture()
    def form_assembler(self, ufl_form: dfn.Form, ufl_coefficients):
        return aut.FormAssembler(Form(ufl_form, ufl_coefficients))

    def test_assemble(self, form_assembler: aut.FormAssembler):
        assert form_assembler.assemble('FIXME')
        assert form_assembler.assemble('FIXME')

    def test_assemble_derivative(self, form_assembler: aut.FormAssembler):
        assert form_assembler.assemble_derivative('FIXME', 'u')
        assert form_assembler.assemble_derivative('FIXME', 'source')
